...
from ...models.paginated_encrypted_backup_bundle_list import (
...
) -> PaginatedEncryptedBackupBundleList | None:
    if response.status_code == 200:
        response_200 = PaginatedEncryptedBackupBundleList.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PaginatedEncryptedBackupBundleList]:
    return Response(

...
from ...models.patched_budget_file import PatchedBudgetFile
...
def _get_kwargs(
    id: str,
    *,
    body: PatchedBudgetFile | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/api/v1/finance/budget-files/{id}/".format(

...
from ...models.paginated_budget_month_list import PaginatedBudgetMonthList
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/finance/budget-months/",
        "params": params,
    }
...
) -> PaginatedBudgetMonthList | None:
    if response.status_code == 200:
        response_200 = PaginatedBudgetMonthList.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PaginatedBudgetMonthList]:
    return Response(

...
from ...models.patched_budget_month import PatchedBudgetMonth
...
def _get_kwargs(
    id: str,
    *,
    body: PatchedBudgetMonth | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/api/v1/finance/budget-months/{id}/".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = BudgetMonth.from_dict(response.json())

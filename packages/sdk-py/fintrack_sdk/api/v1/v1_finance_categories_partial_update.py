...
from ...models.patched_category_v2 import PatchedCategoryV2
...
def _get_kwargs(
    id: str,
    *,
    body: PatchedCategoryV2 | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/api/v1/finance/categories/{id}/".format(

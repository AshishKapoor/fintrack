...
from ...models.paginated_category_group_list import PaginatedCategoryGroupList
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/finance/category-groups/",
        "params": params,
    }
...
) -> PaginatedCategoryGroupList | None:
    if response.status_code == 200:
        response_200 = PaginatedCategoryGroupList.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PaginatedCategoryGroupList]:
    return Response(

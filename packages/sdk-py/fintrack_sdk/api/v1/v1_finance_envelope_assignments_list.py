...
from ...models.paginated_envelope_assignment_list import PaginatedEnvelopeAssignmentList
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/finance/envelope-assignments/",
        "params": params,
    }
...
) -> PaginatedEnvelopeAssignmentList | None:
    if response.status_code == 200:
        response_200 = PaginatedEnvelopeAssignmentList.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PaginatedEnvelopeAssignmentList]:
    return Response(

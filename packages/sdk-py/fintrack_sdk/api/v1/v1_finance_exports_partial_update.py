...
from ...models.patched_export_job import PatchedExportJob
...
def _get_kwargs(
    id: str,
    *,
    body: PatchedExportJob | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/api/v1/finance/exports/{id}/".format(

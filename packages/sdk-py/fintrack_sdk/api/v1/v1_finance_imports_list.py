...
from ...models.paginated_import_job_list import PaginatedImportJobList
...
) -> PaginatedImportJobList | None:
    if response.status_code == 200:
        response_200 = PaginatedImportJobList.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PaginatedImportJobList]:
    return Response(

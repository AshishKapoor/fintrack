...
from ...models.patched_import_job import PatchedImportJob
...
def _get_kwargs(
    id: str,
    *,
    body: PatchedImportJob | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/api/v1/finance/imports/{id}/".format(

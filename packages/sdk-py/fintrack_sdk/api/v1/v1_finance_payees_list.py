...
from ...models.paginated_payee_list import PaginatedPayeeList
...
) -> PaginatedPayeeList | None:
    if response.status_code == 200:
        response_200 = PaginatedPayeeList.from_dict(response.json())

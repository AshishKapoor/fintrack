...
from ...models.paginated_ledger_posting_read_list import PaginatedLedgerPostingReadList
...
) -> PaginatedLedgerPostingReadList | None:
    if response.status_code == 200:
        response_200 = PaginatedLedgerPostingReadList.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PaginatedLedgerPostingReadList]:
    return Response(

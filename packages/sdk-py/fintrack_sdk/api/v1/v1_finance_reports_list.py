...
from ...models.paginated_saved_report_list import PaginatedSavedReportList
...
) -> PaginatedSavedReportList | None:
    if response.status_code == 200:
        response_200 = PaginatedSavedReportList.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PaginatedSavedReportList]:
    return Response(

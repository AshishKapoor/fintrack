...
from ...models.paginated_transaction_rule_list import PaginatedTransactionRuleList
...
) -> PaginatedTransactionRuleList | None:
    if response.status_code == 200:
        response_200 = PaginatedTransactionRuleList.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PaginatedTransactionRuleList]:
    return Response(

...
from ...models.patched_transaction_rule import PatchedTransactionRule
...
def _get_kwargs(
    id: str,
    *,
    body: PatchedTransactionRule | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/api/v1/finance/rules/{id}/".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = TransactionRule.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        body (PatchedTransactionRule | Unset):

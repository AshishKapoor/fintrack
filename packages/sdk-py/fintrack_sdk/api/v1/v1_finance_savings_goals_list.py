...
from ...models.paginated_savings_goal_list import PaginatedSavingsGoalList
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/finance/savings-goals/",
        "params": params,
    }
...
) -> PaginatedSavingsGoalList | None:
    if response.status_code == 200:
        response_200 = PaginatedSavingsGoalList.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PaginatedSavingsGoalList]:
    return Response(

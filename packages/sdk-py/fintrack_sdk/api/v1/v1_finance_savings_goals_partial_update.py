...
from ...models.patched_savings_goal import PatchedSavingsGoal
...
def _get_kwargs(
    id: str,
    *,
    body: PatchedSavingsGoal | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/api/v1/finance/savings-goals/{id}/".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = SavingsGoal.from_dict(response.json())

...
from ...models.paginated_scheduled_transaction_list import (
...
) -> PaginatedScheduledTransactionList | None:
    if response.status_code == 200:
        response_200 = PaginatedScheduledTransactionList.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PaginatedScheduledTransactionList]:
    return Response(

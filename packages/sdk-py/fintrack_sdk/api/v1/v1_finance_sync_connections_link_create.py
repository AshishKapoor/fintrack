...
from ...models.bank_sync_link_result import BankSyncLinkResult
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/finance/sync-connections/{id}/link/".format(
...
) -> BankSyncLinkResult | None:
    if response.status_code == 200:
        response_200 = BankSyncLinkResult.from_dict(response.json())

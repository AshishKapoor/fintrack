...
from ...models.paginated_bank_sync_provider_list import PaginatedBankSyncProviderList
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/finance/sync-connections/providers/",
        "params": params,
    }
...
) -> PaginatedBankSyncProviderList | None:
    if response.status_code == 200:
        response_200 = PaginatedBankSyncProviderList.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PaginatedBankSyncProviderList]:
    return Response(

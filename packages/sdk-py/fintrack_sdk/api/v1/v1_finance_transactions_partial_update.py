...
from ...models.patched_ledger_transaction import PatchedLedgerTransaction
...
def _get_kwargs(
    id: str,
    *,
    body: PatchedLedgerTransaction | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/api/v1/finance/transactions/{id}/".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = LedgerTransaction.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        body (PatchedLedgerTransaction | Unset):

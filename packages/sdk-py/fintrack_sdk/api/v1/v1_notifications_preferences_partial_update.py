...
from ...models.patched_notification_preference import PatchedNotificationPreference
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: PatchedNotificationPreference | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PatchedNotificationPreference | Unset):

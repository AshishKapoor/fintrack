...
T = TypeVar("T", bound="EnvelopeAssignment")


@_attrs_define
class EnvelopeAssignment:
    """
    Attributes:
        id (int):
        budget_month (int):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        budget_month = d.pop("budget_month")
        ...
        envelope_assignment.additional_properties = d
        return envelope_assignment

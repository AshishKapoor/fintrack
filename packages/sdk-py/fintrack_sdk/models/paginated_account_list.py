...
T = TypeVar("T", bound="PaginatedAccountList")
...
class PaginatedAccountList:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = Account.from_dict(results_item_data)
        ...
        paginated_account_list.additional_properties = d
        return paginated_account_list

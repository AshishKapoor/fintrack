...
T = TypeVar("T", bound="PaginatedAuditLogList")
...
class PaginatedAuditLogList:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = AuditLog.from_dict(results_item_data)
        ...
        paginated_audit_log_list.additional_properties = d
        return paginated_audit_log_list

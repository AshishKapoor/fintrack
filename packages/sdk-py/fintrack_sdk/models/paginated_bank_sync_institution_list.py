...
if TYPE_CHECKING:
    from ..models.bank_sync_institution import BankSyncInstitution


T = TypeVar("T", bound="PaginatedBankSyncInstitutionList")


@_attrs_define
class PaginatedBankSyncInstitutionList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[BankSyncInstitution]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = BankSyncInstitution.from_dict(results_item_data)
        ...
        paginated_bank_sync_institution_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_bank_sync_institution_list.additional_properties = d
        return paginated_bank_sync_institution_list

...
if TYPE_CHECKING:
    from ..models.bank_sync_provider import BankSyncProvider


T = TypeVar("T", bound="PaginatedBankSyncProviderList")


@_attrs_define
class PaginatedBankSyncProviderList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[BankSyncProvider]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = BankSyncProvider.from_dict(results_item_data)
        ...
        paginated_bank_sync_provider_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_bank_sync_provider_list.additional_properties = d
        return paginated_bank_sync_provider_list

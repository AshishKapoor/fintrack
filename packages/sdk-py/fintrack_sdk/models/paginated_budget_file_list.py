...
T = TypeVar("T", bound="PaginatedBudgetFileList")


@_attrs_define
class PaginatedBudgetFileList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[BudgetFile]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = BudgetFile.from_dict(results_item_data)
        ...
        paginated_budget_file_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_budget_file_list.additional_properties = d
        return paginated_budget_file_list

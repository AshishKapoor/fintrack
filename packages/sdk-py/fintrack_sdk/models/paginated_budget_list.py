...
T = TypeVar("T", bound="PaginatedBudgetList")


@_attrs_define
class PaginatedBudgetList:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = Budget.from_dict(results_item_data)
        ...
        paginated_budget_list.additional_properties = d
        return paginated_budget_list

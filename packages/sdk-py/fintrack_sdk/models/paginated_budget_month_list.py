...
if TYPE_CHECKING:
    from ..models.budget_month import BudgetMonth


T = TypeVar("T", bound="PaginatedBudgetMonthList")


@_attrs_define
class PaginatedBudgetMonthList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[BudgetMonth]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = BudgetMonth.from_dict(results_item_data)
        ...
        paginated_budget_month_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_budget_month_list.additional_properties = d
        return paginated_budget_month_list

...
T = TypeVar("T", bound="PaginatedCategoryGroupList")


@_attrs_define
class PaginatedCategoryGroupList:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = CategoryGroup.from_dict(results_item_data)
        ...
        paginated_category_group_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_category_group_list.additional_properties = d
        return paginated_category_group_list

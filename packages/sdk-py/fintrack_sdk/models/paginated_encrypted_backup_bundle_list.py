...
if TYPE_CHECKING:
    from ..models.encrypted_backup_bundle import EncryptedBackupBundle


T = TypeVar("T", bound="PaginatedEncryptedBackupBundleList")


@_attrs_define
class PaginatedEncryptedBackupBundleList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[EncryptedBackupBundle]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = EncryptedBackupBundle.from_dict(results_item_data)
        ...
        paginated_encrypted_backup_bundle_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_encrypted_backup_bundle_list.additional_properties = d
        return paginated_encrypted_backup_bundle_list

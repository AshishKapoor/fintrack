...
if TYPE_CHECKING:
    from ..models.envelope_assignment import EnvelopeAssignment


T = TypeVar("T", bound="PaginatedEnvelopeAssignmentList")


@_attrs_define
class PaginatedEnvelopeAssignmentList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[EnvelopeAssignment]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = EnvelopeAssignment.from_dict(results_item_data)
        ...
        paginated_envelope_assignment_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_envelope_assignment_list.additional_properties = d
        return paginated_envelope_assignment_list

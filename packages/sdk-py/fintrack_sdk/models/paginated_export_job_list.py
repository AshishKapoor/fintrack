...
T = TypeVar("T", bound="PaginatedExportJobList")


@_attrs_define
class PaginatedExportJobList:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = ExportJob.from_dict(results_item_data)
        ...
        paginated_export_job_list.additional_properties = d
        return paginated_export_job_list

...
T = TypeVar("T", bound="PaginatedFxRateList")


@_attrs_define
class PaginatedFxRateList:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = FxRate.from_dict(results_item_data)
        ...
        paginated_fx_rate_list.additional_properties = d
        return paginated_fx_rate_list

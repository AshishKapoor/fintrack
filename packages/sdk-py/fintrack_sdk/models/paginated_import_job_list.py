...
T = TypeVar("T", bound="PaginatedImportJobList")


@_attrs_define
class PaginatedImportJobList:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = ImportJob.from_dict(results_item_data)
        ...
        paginated_import_job_list.additional_properties = d
        return paginated_import_job_list

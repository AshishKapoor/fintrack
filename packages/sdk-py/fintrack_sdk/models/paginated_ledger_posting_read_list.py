...
T = TypeVar("T", bound="PaginatedLedgerPostingReadList")


@_attrs_define
class PaginatedLedgerPostingReadList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[LedgerPostingRead]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = LedgerPostingRead.from_dict(results_item_data)
        ...
        paginated_ledger_posting_read_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_ledger_posting_read_list.additional_properties = d
        return paginated_ledger_posting_read_list

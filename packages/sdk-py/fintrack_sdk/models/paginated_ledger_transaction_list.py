...
T = TypeVar("T", bound="PaginatedLedgerTransactionList")


@_attrs_define
class PaginatedLedgerTransactionList:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = LedgerTransaction.from_dict(results_item_data)
        ...
        paginated_ledger_transaction_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_ledger_transaction_list.additional_properties = d
        return paginated_ledger_transaction_list

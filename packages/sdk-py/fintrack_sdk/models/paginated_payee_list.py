...
T = TypeVar("T", bound="PaginatedPayeeList")


@_attrs_define
class PaginatedPayeeList:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = Payee.from_dict(results_item_data)
        ...
        paginated_payee_list.additional_properties = d
        return paginated_payee_list

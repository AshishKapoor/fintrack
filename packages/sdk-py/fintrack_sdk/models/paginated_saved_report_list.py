...
T = TypeVar("T", bound="PaginatedSavedReportList")


@_attrs_define
class PaginatedSavedReportList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[SavedReport]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = SavedReport.from_dict(results_item_data)
        ...
        paginated_saved_report_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_saved_report_list.additional_properties = d
        return paginated_saved_report_list

...
T = TypeVar("T", bound="PaginatedSavingsGoalList")


@_attrs_define
class PaginatedSavingsGoalList:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = SavingsGoal.from_dict(results_item_data)
        ...
        paginated_savings_goal_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_savings_goal_list.additional_properties = d
        return paginated_savings_goal_list

...
if TYPE_CHECKING:
    from ..models.scheduled_transaction import ScheduledTransaction


T = TypeVar("T", bound="PaginatedScheduledTransactionList")


@_attrs_define
class PaginatedScheduledTransactionList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[ScheduledTransaction]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = ScheduledTransaction.from_dict(results_item_data)
        ...
        paginated_scheduled_transaction_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_scheduled_transaction_list.additional_properties = d
        return paginated_scheduled_transaction_list

...
T = TypeVar("T", bound="PaginatedSyncConnectionAccountList")


@_attrs_define
class PaginatedSyncConnectionAccountList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[SyncConnectionAccount]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = SyncConnectionAccount.from_dict(results_item_data)
        ...
        paginated_sync_connection_account_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_sync_connection_account_list.additional_properties = d
        return paginated_sync_connection_account_list

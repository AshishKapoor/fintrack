...
T = TypeVar("T", bound="PaginatedSyncConnectionList")


@_attrs_define
class PaginatedSyncConnectionList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[SyncConnection]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = SyncConnection.from_dict(results_item_data)
        ...
        paginated_sync_connection_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_sync_connection_list.additional_properties = d
        return paginated_sync_connection_list

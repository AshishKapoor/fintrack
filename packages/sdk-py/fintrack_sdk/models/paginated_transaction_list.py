...
T = TypeVar("T", bound="PaginatedTransactionList")
...
class PaginatedTransactionList:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = Transaction.from_dict(results_item_data)
        ...
        paginated_transaction_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_transaction_list.additional_properties = d
        return paginated_transaction_list

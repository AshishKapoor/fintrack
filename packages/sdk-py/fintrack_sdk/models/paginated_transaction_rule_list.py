...
T = TypeVar("T", bound="PaginatedTransactionRuleList")


@_attrs_define
class PaginatedTransactionRuleList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[TransactionRule]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = TransactionRule.from_dict(results_item_data)
        ...
        paginated_transaction_rule_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_transaction_rule_list.additional_properties = d
        return paginated_transaction_rule_list
